...
export default defineConfig({
  ...
  /* The sitemap ships only when the site is meant to be found, and only
     from the real deploy — the GitHub Pages review copy sets PREVIEW_BASE
     and would otherwise publish a sitemap of URLs that are not canonical.
     /style-guide is Kim's internal brand reference, not a public page. */
  integrations: [
    icon({ include: { 'fluent-emoji-flat': ['*'] } }),
    ...(indexable && !previewBase
